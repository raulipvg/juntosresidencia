        ...
        <script src="../assets/js/datatables/datatables.bundle.js?id=2"></script>
        <script src="../assets/js/datatables/contenido/general.js?id=2"></script>


        <!--- Eventos de la pagina -->
        <script src="../assets/js/eventos/general.js?id=2"></script>
